...
class MedicalReportPDF:
    ...
    def generate(self, output_path: str):
        ...
        self.pdf.text(15, 32, f"Generated on: {datetime.now().strftime('%Y-%m-%d %H:%M')} | AI Diagnostic Pipeline v1.0")
        ...
        # 5. Disclaimer Box (Always at bottom or next page)
        ...
        self.pdf.rect(15, self.pdf.get_y(), 180, 25, 'DF')
